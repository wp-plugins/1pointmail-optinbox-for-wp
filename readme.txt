...
Add a 1PointMail subscription box to your wordpress site.
...
1. Upload the plugin zip file to  to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress
3. Configure the API endpoint and your API username and password.
4. Configure the ListID where you want your subscribers to be registered.
5. Place your widget and start collecting subscribers!
